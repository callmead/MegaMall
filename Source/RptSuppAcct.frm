...
Begin VB.Form RptSuppAcct 
   Caption         =   ":: SUPPLIER ACCOUNTS :."
   ClientHeight    =   6585
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8400
   Icon            =   "RptSuppAcct.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "RptSuppAcct.frx":0ECA
   ScaleHeight     =   6585
   ScaleWidth      =   8400
...
Private Sub Form_Load()
    ...
    report.ReportTitle = "Supplier Accounts"
