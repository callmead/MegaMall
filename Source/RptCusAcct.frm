...
Begin VB.Form RptCusAcct 
   Caption         =   ":: CUSTOMER ACCOUNTS :."
   ClientHeight    =   6630
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8400
   Icon            =   "RptCusAcct.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "RptCusAcct.frx":0ECA
   ScaleHeight     =   6630
   ScaleWidth      =   8400
...
Private Sub Form_Load()
    ...
    report.ReportTitle = "Customer Accounts"
