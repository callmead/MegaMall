...
Begin VB.Form RptSupplier 
   Caption         =   ":: SUPPLIER REPORT :."
   ClientHeight    =   6615
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8400
   Icon            =   "RptSupplier.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "RptSupplier.frx":0ECA
   ScaleHeight     =   6615
   ScaleWidth      =   8400
...
Private Sub Form_Load()
    ...
    RptSql = "SELECT * FROM Supplier ORDER BY Supplier_ID;"
    RptPathIs = "\Supplier.rpt"
    ...
    report.ReportTitle = "Supplier Data"
